...
function buildKpi9_5ExcelWorkbook(data) {
  ...
  MRG(1, sigLabel + 4, 2, sigLabel + 7); ctrw(setv(1, sigLabel + 4, meta.roleMengetahui || '', cal12));
  MRG(4, sigLabel + 4, 5, sigLabel + 7); ctrw(setv(4, sigLabel + 4, meta.roleMenyetujui || '', cal11));
