...
const ACCESS_GROUP_LABELS = {
  ...
  kpi_apatd: 'KPI 18.3a Monitoring Debit AP & ATD',
  kpi_pengambilan: 'KPI 18.3b Pengambilan Air Baku',
  kpi_kualitas: 'KPI 18.4 Laporan Kualitas Air Baku',
  kpi_18_5: 'KPI 18.5 Monitoring Kondisi Peralatan',
  kpi_18_6: 'KPI 18.6 Jadwal PM Terkendali',
  kpi_activity_plan: 'Activity Plan SAB',
  kpi_9_2: 'KPI 9.2 Laporan Kualitas Air Baku',
  kpi_9_3: 'KPI 9.3 Laporan Kondisi Air Waduk',
  kpi_9_7: 'KPI 9.7 Laporan Kondisi Air Sumur',
  pekerjaan_sab: 'Riwayat Pekerjaan SAB',
